...
const TOPICS = [
  { subject: "寿司ネタの人気度", low: "たまご", high: "大トロ" },
  { subject: "動物の人気度", low: "モルモット", high: "パンダ" },
  { subject: "コンビニスイーツの背徳感", low: "フルーツゼリー", high: "生クリームたっぷりのショートケーキ" },
  { subject: "カラオケで盛り上がる曲度", low: "校歌", high: "誰もが知る国民的アニメの主題歌" },
  { subject: "ラーメンの背徳感", low: "塩ラーメン", high: "こってり豚骨の全部乗せ" },
  { subject: "芸能人の知名度", low: "地方のローカルタレント", high: "国民的な大スター" },
  { subject: "給食で人気だったメニュー度", low: "ひじきの煮物", high: "揚げパン" },
  { subject: "お祭りの屋台の人気度", low: "型抜き", high: "たこ焼き" },
  { subject: "スポーツのハードさ", low: "ラジオ体操", high: "トライアスロン" },
  { subject: "遊園地アトラクションのスリル度", low: "メリーゴーランド", high: "フリーフォール" },
  { subject: "ペットとして人気の生き物度", low: "ザリガニ", high: "犬・猫" },
  { subject: "コンビニおにぎりの具の人気度", low: "ひじき", high: "鮭" },
  { subject: "甘いものの背徳度", low: "フルーツの盛り合わせ", high: "生クリーム山盛りのパフェ" },
  { subject: "お風呂・温泉の熱さ", low: "ぬる湯", high: "沸騰しそうなくらい激熱なお風呂" },
  { subject: "花火大会の規模", low: "町内会の小さな花火大会", high: "全国有数の大型花火大会" },
  { subject: "ゲームのボスの強さ", low: "チュートリアルの雑魚敵", high: "何十回も挑む裏ボス" },
  { subject: "お笑いのツッコミの鋭さ", low: "優しく流すツッコミ", high: "一撃で場を支配する鋭いツッコミ" },
  { subject: "部活・サークルのきつさ", low: "週1でゆるく楽しむ同好会", high: "休みなしの強豪校" },
  { subject: "猫の毛のモフモフ度", low: "毛の短い短毛種", high: "長毛のふわふわ大型猫" },
  { subject: "お土産として喜ばれる度", low: "ご当地キーホルダー", high: "誰もが知る有名銘菓" },
  { subject: "夏フェスの規模", low: "地元の小さな野外ライブ", high: "チケット争奪戦になる超人気フェス" },
  { subject: "朝ごはんの満足度", low: "コーヒーだけで済ます", high: "ホテルの朝食ビュッフェ" },
  { subject: "動物園・水族館の人気者度", low: "あまり注目されない生き物", high: "グッズが売り切れる看板スター" },
  { subject: "コスプレの完成度", low: "カチューシャをつけただけ", high: "プロ仕込みのウィッグ・造形" },
  { subject: "100円ショップの掘り出し物度", low: "よくある文房具", high: "SNSでバズった収納グッズ" },
  { subject: "お笑い番組の腹筋崩壊度", low: "くすっと笑う程度", high: "涙が出るほど笑い転げる" },
  { subject: "都市伝説の信憑性", low: "明らかに作り話とわかる噂", high: "本気で信じている人が多い噂" },
  { subject: "幼少期の憧れの職業度", low: "あまり人気のなかった職業", high: "クラスの半分が憧れた職業" },
  { subject: "スイーツビュッフェの満足度", low: "コンビニのプリン1個", high: "高級ホテルのスイーツビュッフェ" },
  { subject: "旅行先としての人気度", low: "隣町", high: "一度は行きたい海外の憧れの地" },
];
